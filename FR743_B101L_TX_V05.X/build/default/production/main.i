...
int main(void) {
  ...
  while (1) {
    ...
    if((PORTAbits.RA3 == 1) && (PORTAbits.RA1 == 1) && (PORTAbits.RA0 == 1)){
      ...
      SW_STATE_Data[2] = 0x00;
      SW_STATE_Data[3] = 0x00;
      SW_STATE_Data[4] = 0x07;
      SW_STATE_Data[5] = 0x00;
      SW_STATE_Data[6] = 0x00;
      SW_STATE_Data[7] = 0x00;
    }else if((PORTAbits.RA3 == 1) && (PORTAbits.RA1 == 1) && (PORTAbits.RA0 == 0)){
      do { LATBbits.LATB2 = 0; } while(0);
      do { LATBbits.LATB4 = 0; } while(0);
      ...
      SW_STATE_Data[6] = 0x00;
      SW_STATE_Data[7] = 0x00;
    }else if((PORTAbits.RA3 == 1) && (PORTAbits.RA1 == 0) && (PORTAbits.RA0 == 1)){
      do { LATBbits.LATB2 = 0; } while(0);
      do { LATBbits.LATB4 = 1; } while(0);
      do { LATBbits.LATB5 = 0; } while(0);
      SW_STATE_Data[0] = 0x24;
      SW_STATE_Data[1] = 0x00;
      SW_STATE_Data[2] = 0x40;
      SW_STATE_Data[3] = 0x00;
      SW_STATE_Data[4] = 0x07;
      SW_STATE_Data[5] = 0x00;
      SW_STATE_Data[6] = 0x00;
      SW_STATE_Data[7] = 0x00;
    }else if((PORTAbits.RA3 == 1) && (PORTAbits.RA1 == 0) && (PORTAbits.RA0 == 0)){
      ...
      SW_STATE_Data[6] = 0x00;
      SW_STATE_Data[7] = 0x00;
    }else if((PORTAbits.RA3 == 0) && (PORTAbits.RA1 == 1) && (PORTAbits.RA0 == 1)){
      do { LATBbits.LATB2 = 1; } while(0);
      do { LATBbits.LATB4 = 0; } while(0);
      do { LATBbits.LATB5 = 0; } while(0);
      SW_STATE_Data[0] = 0x24;
      SW_STATE_Data[1] = 0xC0;
      SW_STATE_Data[2] = 0x00;
      SW_STATE_Data[3] = 0x00;
      SW_STATE_Data[4] = 0x07;
      SW_STATE_Data[5] = 0x00;
      SW_STATE_Data[6] = 0x00;
      SW_STATE_Data[7] = 0x00;
    }if((PORTAbits.RA3 == 0) && (PORTAbits.RA1 == 1) && (PORTAbits.RA0 == 0)){
      do { LATBbits.LATB2 = 1; } while(0);
      do { LATBbits.LATB4 = 0; } while(0);
      do { LATBbits.LATB5 = 1; } while(0);
      SW_STATE_Data[0] = 0x24;
      ...
      SW_STATE_Data[6] = 0x00;
      SW_STATE_Data[7] = 0x00;
    }if((PORTAbits.RA3 == 0) && (PORTAbits.RA1 == 0) && (PORTAbits.RA0 == 1)){
      do { LATBbits.LATB2 = 1; } while(0);
      do { LATBbits.LATB4 = 1; } while(0);
      do { LATBbits.LATB5 = 0; } while(0);
      SW_STATE_Data[0] = 0x24;
      ...
      SW_STATE_Data[6] = 0x00;
      SW_STATE_Data[7] = 0x00;
    }if((PORTAbits.RA3 == 0) && (PORTAbits.RA1 == 0) && (PORTAbits.RA0 == 0)){
      do { LATBbits.LATB2 = 1; } while(0);
      do { LATBbits.LATB4 = 1; } while(0);
      do { LATBbits.LATB5 = 1; } while(0);
      SW_STATE_Data[0] = 0x24;
